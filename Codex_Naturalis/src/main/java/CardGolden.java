...
/**
 * The CardGolden class extends the CardResource class by adding constraints to its playability and
...
public class CardGolden extends CardResource {
    ...
    /**
     * Constructor for CardGolden without point multipliers
     ...
     */
    public CardGolden(Corner[] corners, Resource resource, int points, Map<Resource, Integer> constraint) {
        super(corners, resource, points);
        this.constraint = constraint;
    }

    /**
     * Constructor for CardGolden with point multiplier
     * @param corners           Array containing the corners of the card.
     * @param resource          Resource type of the card. Allowed values are: ANIMAL,FUNGI,INSECT,PLANT.
     * @param points            Points awarded by playing the card Face-Up.
     * @param constraint        Map<Resource, Integer>, Key is the required resource, value is the amount of it that is required.
     ...
     */
    public CardGolden(Corner[] corners, Resource resource, int points, Map<Resource, Integer> constraint, Item requiredItem, boolean requiresCorner) {
        super(corners, resource, points);
        this.constraint = constraint;
