...
import it.polimi.ingsw.Server.Model.Game.Table.CardPool;
...
class GameTest {
    ...
    public class checkGameEndingConditionsTest{
        ...
        void scenarioBuilder(Map<CardPoolTypes, CardPool> cardPools, List<Player> players, boolean expectedLastRoundTrigger){
            ...
            String cardJsonPath = "src/test/java/it/polimi/ingsw/Server/Model/Game/Logic/Resources/DefaultResourceCards.txt";
            String cardJson;
